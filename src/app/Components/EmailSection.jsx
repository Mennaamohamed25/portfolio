  ...
  return (
   ...
   className="grid md:grid-cols-2 my-12  py-24 gap-4 relative">
    ...
    <div className="z-10">
        ...
        <p className='text-[#ADB7BE] mb-4 max-w-md'>I'm currently looking for a new opportunity, my inbox is always open.
          Whether you have a question or  want to hire me, I will
    ...
    <div className="z-10">
        <form className='flex flex-col' onSubmit={handelSubmitted}>
          ...
          <label htmlFor='email' className='text-white block mb-2 text-sm font-medium '>Your Email </label>
            <input type='email' id='email' name='email' required placeholder='example@gmail.com' className='bg-[#18191E] border border-[#33353F] placeholder-[#9CA2A9] text-gray-100 text-sm rounded-lg block w-full p-2.5'/> 
          </div>


          <div className='mb-6'>  
            <label htmlFor='subject' className='text-white block text-sm mb-2 font-medium'>Subject </label>
            <input type='text' id='subject' name='subject' required placeholder='Enter your subject' className='bg-[#18191E] border border-[#33353F] placeholder-[#9CA2A9] text-gray-100 text-sm rounded-lg block w-full p-2.5'/> 
            </div>
